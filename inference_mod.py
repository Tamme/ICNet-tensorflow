...
def get_arguments():
    ...
    parser.add_argument("--imgs-path-dir", type=str, default='',
...
def main():
    ...
    img_paths = []
    for img_name in os.listdir(args.imgs_path_dir):
        img_paths.append(os.path.join(args.imgs_path_dir, img_name))
    img_paths = sorted(img_paths)

    img, filename = load_img(img_paths[0])
    shape = img.shape[0:2]
